        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    apple_id = table.Column<string>(type: "text", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    last_login_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    revenuecat_id = table.Column<string>(type: "text", nullable: true),
                    is_premium = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    premium_expiration = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    last_revenuecat_event = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_product_ingredients", x => new { x.product_code, x.ingredient_id });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_product_ingredients_products_product_code",
                        column: x => x.product_code,
                        principalTable: "products",
                        principalColumn: "code",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_product_history_products_product_code",
                        column: x => x.product_code,
                        principalTable: "products",
                        principalColumn: "code",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_product_history_users_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_favorite_products", x => new { x.user_id, x.product_code });
                    table.ForeignKey(
                        name: "FK_user_favorite_products_products_product_code",
                        column: x => x.product_code,
                        principalTable: "products",
                        principalColumn: "code",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "idx_food_groups_name_unique",
                table: "food_groups",
                column: "name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "idx_food_groups_name_gin",
                table: "food_groups",
                column: "name")
                .Annotation("Npgsql:IndexMethod", "gin")
                .Annotation("Npgsql:IndexOperators", new[] { "gin_trgm_ops" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_product_history_product_code",
                table: "product_history",
                column: "product_code");

            migrationBuilder.CreateIndex(
                name: "IX_product_history_scanned_at",
                table: "product_history",
                column: "scanned_at");

            migrationBuilder.CreateIndex(
                name: "IX_product_history_user_id",
                table: "product_history",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "idx_product_ingredients_ingredient",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_products_product_name_gin",
                table: "products",
                column: "product_name")
                .Annotation("Npgsql:IndexMethod", "gin")
                .Annotation("Npgsql:IndexOperators", new[] { "gin_trgm_ops" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_favorite_products_favorited_at",
                table: "user_favorite_products",
                column: "favorited_at");

            migrationBuilder.CreateIndex(
                name: "IX_user_favorite_products_product_code",
                table: "user_favorite_products",
                column: "product_code");
